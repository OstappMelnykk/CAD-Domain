...
public static class DefaultCube
{
    ...
    {
        new ComplexPoint(new Simple3DPoint(-1, -1, -1)),
        new ComplexPoint(new Simple3DPoint(1, -1, -1)),
        new ComplexPoint(new Simple3DPoint(-1, -1, 1)),
        new ComplexPoint(new Simple3DPoint(1, -1, 1)),
        new ComplexPoint(new Simple3DPoint(-1, 1, -1)),
    ...
    {
        new ComplexPoint(new Simple3DPoint(0, -1, -1)),
        new ComplexPoint(new Simple3DPoint(-1, -1, 0)),
        new ComplexPoint(new Simple3DPoint(1, -1, 0)),
        new ComplexPoint(new Simple3DPoint(0, -1, 1)),
        new ComplexPoint(new Simple3DPoint(-1, 0, -1)),
        new ComplexPoint(new Simple3DPoint(1, 0, -1)),
        new ComplexPoint(new Simple3DPoint(-1, 0, 1)),
        new ComplexPoint(new Simple3DPoint(1, 0, 1) ),
        new ComplexPoint(new Simple3DPoint(0, 1, -1)),
